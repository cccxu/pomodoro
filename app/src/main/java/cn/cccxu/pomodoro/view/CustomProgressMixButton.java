 ...
 */
public class CustomProgressMixButton extends View {
    // 画实心圆的画笔
    ...
    public CustomProgressMixButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        // 获取自定义的属性
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        TypedArray typeArray = context.getTheme().obtainStyledAttributes(attrs,
                R.styleable.CustomProgressMixButton, 0, 0);
        mRadius = typeArray.getDimension(R.styleable.CustomProgressMixButton_radius, 300);
        mStrokeWidth = typeArray.getDimension(R.styleable.CustomProgressMixButton_strokeWidth, 20);
        mCircleColor = typeArray.getColor(R.styleable.CustomProgressMixButton_circleColor, Color.BLUE);
        mRingColor = typeArray.getColor(R.styleable.CustomProgressMixButton_ringColor, Color.RED);
        mTotalProgress = typeArray.getInt(R.styleable.CustomProgressMixButton_totalProgress, 100);
        mTextColor = typeArray.getColor(R.styleable.CustomProgressMixButton_textColor, Color.WHITE);
        mBigCircleColor = typeArray.getColor(R.styleable.CustomProgressMixButton_bigCircleColor, Color.WHITE);
        mRectColor = typeArray.getColor(R.styleable.CustomProgressMixButton_rectColor, Color.WHITE);
        txt = "1";
